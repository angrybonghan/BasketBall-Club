...
public class Move_Skill : Skill
{
    ...
    public override IEnumerator Act()
    {
        ...
        main_player_index = gm.Get_Index_Of_Player(main_player);
        target_player_index = gm.Get_Index_Of_Player(target_player);

        Change_Player_Index_And_Position();
    }

    private void Change_Player_Index_And_Position()
    {
